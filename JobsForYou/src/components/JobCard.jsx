...
const JobCard = (props) => {
  ...
  return (
    <div className='mx-40 mb-4 '>
        <div className='flex  flex-wrap justify-between items-center px-6 py-4 bg-zinc-200 rounded-md border border-black shadow-lg hover:border-blue-500 hover:translate-y-1 hover:scale-103'>
            ...
            <div className='flex items-center gap-4'>
                <p className='text-gray-500 '>{(diffInDays)>1?`posted ${diffInDays} days ago`:`posted ${diffInDays} day ago`}</p>
